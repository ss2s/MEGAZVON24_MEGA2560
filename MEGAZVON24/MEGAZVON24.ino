...
#define RELE_K1 1  // 1 колокол (реле 1)
#define RELE_K2 2  // 2 колокол (реле 2)
#define RELE_K3 3  // 3 колокол (реле 3)
#define RELE_K4 34  // 4 колокол (реле 4)
#define RELE_K5 35  // 5 колокол (реле 5)
#define RELE_K6 36  // 6 колокол (реле 6)
#define RELE_K7 37  // 7 колокол (реле 7)
#define RELE_K8 38  // 8 колокол (реле 8)
#define RELE_K9 39  // 9 колокол (реле 9)
#define RELE_K10 40  // 10 колокол (реле 10)
#define RELE_K11 11  // 11 колокол (реле 11)
#define RELE_K12 12  // 12 колокол (реле 12)
#define RELE_K13 13  // 13 колокол (реле 13)
#define RELE_K14 14  // 14 колокол (реле 14)
#define RELE_K15 15  // 15 колокол (реле 15)
#define RELE_K16 16  // 16 колокол (реле 16)
#define RELE_K17 17  // 17 колокол (реле 17)
#define RELE_K18 18  // 18 колокол (реле 18)
#define RELE_K19 19  // 19 колокол (реле 19)
#define RELE_K20 20  // 20 колокол (реле 20)
#define RELE_K21 21  // 21 колокол (реле 21)
#define RELE_K22 22  // 22 колокол (реле 22)
#define RELE_K23 23  // 23 колокол (реле 23)
#define RELE_K24 24  // 24 колокол (реле 24)
...
// для каждой ноты в отдельности. здесь калибруется длительность сработки язычка для каждой ноты в мс по умолчанию 300
#define DEF_TIME_OF_BLOW_UNIC_NOTA_1 300   // ВРЕМЯ УДАРА ЯЗЫЧКА В 1 КОЛОКОЛ В МИЛЛИСЕКУНДАХ (ВРЕМЯ НОТЫ)
#define DEF_TIME_OF_BLOW_UNIC_NOTA_2 300   // ВРЕМЯ УДАРА ЯЗЫЧКА В 2 КОЛОКОЛ В МИЛЛИСЕКУНДАХ (ВРЕМЯ НОТЫ)
...
byte customCharBell[8] = {  // колокольчик для дисплея
	0b00000,
	0b00100,
	0b01110,
	0b01110,
...
byte customCharNota[8] = {  // нота для дисплея
	0b01110,
	0b01111,
	0b01001,
	0b01001,
...
// НОТЫ ПО УМОЛЧАНИЮ: для каждой ноты можно настроить время работы реле по умолчанию. менять цифру
...
void setup() {
	...
	// инициализация пользовательских символов
  	...
  	lcd.createChar(1, customCharNota);
