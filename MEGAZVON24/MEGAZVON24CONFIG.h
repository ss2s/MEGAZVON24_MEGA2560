...
// ДВА НАБОРА НАСТРОЕК ДЛИТЕЛЬНОСТИ НОТ (ЗИМА, ЛЕТО) по умолчанию #define ZIMA
// для включения летнего набора нот, изменить #define ZIMA на #define LETO

#define ZIMA  // ZIMA, LETO
